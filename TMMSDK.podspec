...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/Syd"
  ...
  s.source_files  = "TMMSDK.framework/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "TMMSDK.framework/**/*.h"
  ...
  spec.resource = "Resources/TMMSDKBundle.bundle"
